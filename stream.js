...
// ================================= 1111111111111111----------eeeeeeeeeeeeeeeeeeeeeeeeee ==================================== belwo code new error come

// [💓] WATCHDOG HEARTBEAT: Status is HEALTHY | Video Time: 198.1s
// [▶️] CURRENTLY LIVE   : Server [0] (Audio ON) -> https://dlhd.st/watch.php?id=111
// [⏭️] NEXT IN QUEUE    : Server [1] (Audio MUTED) -> https://dlhd.st/watch.php?id=114
// [📸] Screenshot saved: ./screenshots/snap_2026-07-18T10-27-25-937Z_heartbeat-tick-120.png

// [💓] WATCHDOG HEARTBEAT: Status is HEALTHY | Video Time: 380.2s
// [▶️] CURRENTLY LIVE   : Server [0] (Audio ON) -> https://dlhd.st/watch.php?id=111
// [⏭️] NEXT IN QUEUE    : Server [1] (Audio MUTED) -> https://dlhd.st/watch.php?id=114
// [📸] Screenshot saved: ./screenshots/snap_2026-07-18T10-31-28-359Z_heartbeat-tick-240.png

// [💓] WATCHDOG HEARTBEAT: Status is HEALTHY | Video Time: 562.3s
// [▶️] CURRENTLY LIVE   : Server [0] (Audio ON) -> https://dlhd.st/watch.php?id=111
// [⏭️] NEXT IN QUEUE    : Server [1] (Audio MUTED) -> https://dlhd.st/watch.php?id=114

// [⚠️] HANG DETECTED: Stream lag check start... Monitoring recovery.
// [✅] RECOVERY SUCCESS: Stream wapas start! Hang Time: 4.0s | Score: 100


// [⚠️] HANG DETECTED: Stream lag check start... Monitoring recovery.
// [✅] RECOVERY SUCCESS: Stream wapas start! Hang Time: 4.1s | Score: 100
...
// [⚠️] HANG DETECTED: Stream lag check start... Monitoring recovery.
// [⏳] HANG MONITOR: Stream stuck... (4.0s) | Score: 98
// [✅] RECOVERY SUCCESS: Stream wapas start! Hang Time: 8.1s | Score: 96


// [⚠️] HANG DETECTED: Stream lag check start... Monitoring recovery.
// [⏳] HANG MONITOR: Stream stuck... (4.0s) | Score: 95
// [⏳] HANG MONITOR: Stream stuck... (8.1s) | Score: 91
// [✅] RECOVERY SUCCESS: Stream wapas start! Hang Time: 10.1s | Score: 91


// [⚠️] HANG DETECTED: Stream lag check start... Monitoring recovery.

// ==================================================
// [!] ❌ WATCHDOG DETECTED ISSUE: BUFFERING
// [💀] FAILED STREAM: Server [0] -> https://dlhd.st/watch.php?id=111
// ==================================================
// [📸] Screenshot saved: ./screenshots/snap_2026-07-18T10-35-29-085Z_error-buffering.png
// [*] Checking Backup Tab status before switching...
// [⚠️] Backup is NOT ready (BUFFERING). Initiating Background Self-Healing Recovery!
// [*] Loading Recovery Page in background... URL: https://dlhd.st/watch.php?id=111

// [💓] WATCHDOG HEARTBEAT: Status is BUFFERING | Video Time: N/A
// [▶️] CURRENTLY LIVE   : Server [0] (Audio ON) -> https://dlhd.st/watch.php?id=111
// [⏭️] NEXT IN QUEUE    : Server [1] (Audio MUTED) -> https://dlhd.st/watch.php?id=114
// [📸] Screenshot saved: ./screenshots/snap_2026-07-18T10-35-33-796Z_heartbeat-tick-360.png

// ==================================================
// [!] ❌ WATCHDOG DETECTED ISSUE: BUFFERING
// [💀] FAILED STREAM: Server [0] -> https://dlhd.st/watch.php?id=111
// ==================================================
// [📸] Screenshot saved: ./screenshots/snap_2026-07-18T10-35-33-862Z_error-buffering.png
// [⏳] Background recovery in progress... Status: DEAD
...
// [💀] FAILED STREAM: Server [0] -> https://dlhd.st/watch.php?id=111
// ==================================================
// [📸] Screenshot saved: ./screenshots/snap_2026-07-18T10-35-35-911Z_error-buffering.png
// [⏳] Background recovery in progress... Status: BUFFERING

// ==================================================
// [!] ❌ WATCHDOG DETECTED ISSUE: BUFFERING
// [💀] FAILED STREAM: Server [0] -> https://dlhd.st/watch.php?id=111
// ==================================================
// [📸] Screenshot saved: ./screenshots/snap_2026-07-18T10-35-40-463Z_error-buffering.png
// [⏳] Background recovery in progress... Status: BUFFERING
...
// [💀] FAILED STREAM: Server [0] -> https://dlhd.st/watch.php?id=111
// ==================================================
// [📸] Screenshot saved: ./screenshots/snap_2026-07-18T10-35-42-499Z_error-buffering.png
// [⏳] Background recovery in progress... Status: BUFFERING
...
//     // Background Recovery State
//     let isRecoveringBackground = false;
...
//                     // Keep freeze threshold strictly at the maximum value
...
//             // Check if we are already in the middle of a background recovery
//             if (isRecoveringBackground && recoveryPage) {
//                 let recoveryStatus = await checkPageStatus(recoveryPage);
//                 if (recoveryStatus.status === 'HEALTHY') {
//                     console.log(`[✅] BACKGROUND RECOVERY SUCCESS! New page is fully playing. Swapping now...`);
                    
//                     let oldBrokenPage = activePage;
...
//                     try { await oldBrokenPage.close(); } catch(e) {}
...
//                     removeRecoveryOverlay(activePage);
//                     continue;
//                 } else if (recoveryStatus.status === 'CRITICAL_ERROR') {
//                     console.log(`[❌] Background recovery hit a critical error. Falling back to next server...`);
//                     isRecoveringBackground = false;
//                     try { await recoveryPage.close(); } catch(e) {}
//                     recoveryPage = null;
//                 } else {
//                     console.log(`[⏳] Background recovery in progress... Status: ${recoveryStatus.status}`);
//                     await new Promise(r => setTimeout(r, 2000));
//                     continue; 
//                 }
//             }
...
//             let canHotSwap = (backupStatus.status === 'HEALTHY');

//             if (isProactiveRefresh || canHotSwap) {
...
//             } else {
//                 // Backup is NOT ready! Initiate Background Self-Healing Recovery!
//                 console.log(`[⚠️] Backup is NOT ready (${backupStatus.status}). Initiating Background Self-Healing Recovery!`);
//                 isRecoveringBackground = true;
                
//                 (async () => {
//                     try {
//                         recoveryPage = await browser.newPage();
//                         await setupNetworkAdBlocker(recoveryPage);
//                         attachAntiAdListeners(recoveryPage);
//                         await applyPreloadFirewall(recoveryPage);

//                         console.log(`[*] Loading Recovery Page in background... URL: ${activeUrlStr}`);
//                         await recoveryPage.goto('about:blank').catch(()=>{});
//                         await recoveryPage.goto(activeUrlStr, { waitUntil: 'domcontentloaded', timeout: 60000 }).catch(()=>{});
                        
//                         await new Promise(r => setTimeout(r, 1000));
//                         try { await recoveryPage.mouse.click(10, 10); } catch(e) {}
                        
//                         await initializeVideo(recoveryPage, true, false); 
//                     } catch (err) {
//                         console.log(`[❌] Recovery page creation failed: ${err.message}`);
//                         isRecoveringBackground = false;
//                     }
//                 })();
...
//             const newPage = await target.page();
//             setTimeout(async () => {
//                 if (newPage && newPage !== activePage && newPage !== backupPage && newPage !== recoveryPage) {
//                     console.log(`[🛡️] AD-BLOCKER: Killed an unwanted pop-up tab!`);
//                     try { await newPage.close(); } catch (e) { }
//                 }
//             }, 500);
...
// ================================= remove threshold mines point 11111111111111111111----------dddddddddddddddddd ====================================


// =================== remove the threshold decrese code =================================
// [✅] RECOVERY SUCCESS: Stream wapas start! Hang Time: 6.0s | Score: 92
// [📉] Unstable stream detected (3 recent freezes). Lowering freeze threshold to 7.0s
// [⚠️] HANG DETECTED: Stream lag check start... Monitoring recovery.
// [⏳] HANG MONITOR: Stream stuck... (4.0s) | Score: 90
// =========================================================================================
...
// ========================== 111111111111111111111111-cccccccccccccccccccccccccccccccccccc (remove 35 seconds dead wait from the 111111111111----bbbbbbbb code ) ***** but this code threshold minues code.
